<template>
    ...
    <br>
        ...
        <table class="tab" border="1">
            ...
            <h1 align="left">ตั้งค่าบัญชีผู้ใช้</h1><br>

                    <table border="0">
                    <tr>
                        <td><img src="../images/people.jpg"  align="left" width="150" height="150"><br><br></td>
                        <td width="50"></td>
                        <td>
                            <tr><td>
                    ...
                    <tr><td colspan="1">สถานะผู้ใช้ : {{userData.role}}</td></tr>
                </table>
